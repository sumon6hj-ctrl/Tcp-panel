...
def main():
    ...
    try:
        ...
        # bot.run()
        print("Nayemofcl-V1 Bot is starting safely...")
...
def send_likes(uid):
    try:
        ...
        likes_api_response = requests.get(
             f"https://jubayer-like-api.vercel.app/like?uid={uid}&server_name=bd",
             timeout=15
        )
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][DA70D6]❀️Owner:[00FFFF]</> Hꫝsɪʙㅤ6T9
"""
...
def send_insta_info(username):
    try:
        response = requests.get(f"https://mg24-gamer-king.vercel.app/yt-info/yt?channel={channel_name.lstrip('@')}", timeout=15)
        if response.status_code != 200:
...
[C][B][00FFFF]━━━━━━━━━━━
[C][B][FFFFFF]Developer     : ㅤHꫝsɪʙㅤ6T9 """
    except requests.exceptions.RequestException:
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]hasib_hi
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FB0364]╭[D21A92]─[BC26AB]╮[00BFFF]╔═══════╗\n[B][C][FF7244]│[FE4250]▶[C81F9C]֯│[FFFF00]║[FFFFFF] WLC Hꫝsɪʙ TCP  [FFFF00]║\n[B][C][FDC92B]╰[FF7640]─[F5066B]╯[00BFFF]╚═══════╝"""
...
[b][c][00FF00]Wʟᴄ Tᴏ Hꫝsɪʙㅤ6T9 Bᴏᴛ Hᴇʀᴇ 
❀️ [B][C][00FFFF]╭[00FFFF]─[00FFFF]╮[00FFFF]╔═══════╗
[C][B][00FFFF]│[FFFFFF]ꚠ[00FFFF]│[00FFFF]║[FFFFFF]ㅤHꫝsɪʙㅤ6T9 BOT[00FFFF]║
...
# ==================== /dice COMMAND ====================
                        if inPuTMsG.strip().startswith('/dice'):
                            ...
                            colors = {1:"FF0000", 2:"FFD700", 3:"FFFF00", 4:"00FF00", 5:"00FFFF", 6:"FFFFFF"}
                            dice_message = (
                        ...
                        if inPuTMsG.startswith('/exit'):
                            ...
                            # SUCCESS MESSAGE
                            success_message = f"[B][C][FF00FF]✅ SUCCESS! Left the squad successfully!\n"
                            await safe_send_message(response.Data.chat_type, success_message, uid, chat_id, key, iv)
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    messages = [
                                        ...
                                        "B][C][FFFFFF]♡ [00FF00]লবিতে [FFFFFF]শুধু [FFD700]তোকেই খুঁজি [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [00FFFF]এয়ারড্রপের [FFFFFF]চেয়েও [FF1493]তুই দামি [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [FFD700]তোর হাসিতে [FFFFFF]আমার [00FF00]HP বাড়ে [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [FF00FF]তুই ছাড়া [FFFFFF]গেম খেলা [00FFFF]পুরোই বৃথা [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [FFA500]স্নাইপারের [FFFFFF]একমাত্র [FF1493]লক্ষ্য তুই [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [32CD32]তুই আমার [FFFFFF]গ্লু-ওয়ালের [FFD700]কভার [FFFFFF]♡",
                                        "[B][C][FFFFFF]♡ [FF0000]চল দুজনে [FFFFFF]মিলে [00FFFF]বুইয়া নিই [FFFFFF]♡"
                                            ]
                        ...
                        if inPuTMsG.strip().startswith('/f'):
                            ...
                            if len(parts) < 4:
                                ...
                                try:
                                    ...
                                    error_msg = f"[B][C][FF0000]❌ ERROR! Invalid number format! Usage: /f (uid) (emote_id) (times)\n"
                                    await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                                except Exception as e:
                                    error_msg = f"[B][C][FF0000]❌ ERROR! {str(e)}\n"
                                    await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
...
# ==================== /dhadha COMMAND ====================
                        ...
                        if inPuTMsG.strip().lower() in ("hasib", "/help", "hi", "hello", "5"):
...
[B][00BFFF]├─[00FF00]/bundle [FFFFFF][name]
[B][00BFFF]──────────────────"""
...
[B][C][00FF00] গিল্ড এর নিয়ম পতি সপ্তা এ ❀️১০০০ গ্লরি দিতে হবে
[FFFF00]━━━━━━━━━━━"""
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞HASIBᅠ BOT - INITIALIZING")
    print("=" * 50)
